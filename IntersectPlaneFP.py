...
__title__ = "Intersect Plane"
__author__ = "Christophe Grellier (Chris_G)"
__license__ = "LGPL 2.1"
__doc__ = """Creates a planar face that contains intersections with external shapes.
             This object is supposed to be used as support for sketches."""
...
TOOL_ICON = _utils.iconsPath() + '/intersectPlane.svg'

class IntersectPlaneFP:
    """Creates a planar face that contains intersections with external shapes."""
    def __init__(self, obj, src):
        """Add the properties"""
        obj.addProperty("App::PropertyLink",        "SourceObject", "IntersectPlane", "Source object")
        obj.addProperty("App::PropertyLinkSubList", "SourceShapes", "IntersectPlane", "Individual source shapes")
        #obj.addProperty("App::PropertyVector", "ViewPos", "IntersectPlane", "View position")
        #obj.addProperty("App::PropertyVector", "ViewDir", "IntersectPlane", "View direction")
        #obj.addProperty("App::PropertyVector", "UpDir",   "IntersectPlane", "Up direction")
        #obj.ViewPos = FreeCAD.Vector(0,0,0)
        #obj.ViewDir = FreeCAD.Vector(0,0,1)
        #obj.UpDir   = FreeCAD.Vector(0,1,0)
        if isinstance(src,(list,tuple)):
            obj.SourceShapes = src
        else:
            obj.Source = src
        obj.Proxy = self
